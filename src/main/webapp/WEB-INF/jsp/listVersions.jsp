...
<html>
	<head>
		...
		<script src="<c:url value="http://code.jquery.com/jquery-migrate-1.1.0.js"/>" type="text/javascript"></script>
		<script src="<c:url value="/resources/jQuery/js/jquery.tablesorter.widgets.js"/>" type="text/javascript"></script>
	...
	<body>
		...
		<h1>
			...
			<a class="btn btn-primary" href="addVersionForm.html">ADD</a>
		</h1>
		...
		<c:if test="${!empty versionList}">
			...
			<table id="myTable" class="tablesorter">
				<thead>
					<tr>
					    <th data-placeholder="Search...">Versions</th>
					    <th data-placeholder="Search...">Release Dates</th>
					</tr>
				</thead>
