...
<html>
	...
	<body>
		...
		<h1>
			List of Problems
			<a class="btn btn-primary" href="addProblemForm.html">ADD</a>
		</h1>
		...
		<c:if test="${!empty problemList}">
			...
			<table id="myTable" class="tablesorter">
				<thead>
					<tr>
					    <th data-placeholder="Search...">Problem</th>
					    <th data-placeholder="Search...">Date Reported</th>
					    <th data-placeholder="Search...">Software Version</th>
					</tr>
				</thead>
				<c:forEach items="${problemList}" var="problem">
				    <tr>
				        <td>
				        	${problem.problem} 
				        	(<a href="editProblemForm/${problem.id}.html">edit</a>)
				        </td>
